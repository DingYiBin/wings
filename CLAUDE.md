...
- `tools/builtin/` — 7 tools (read, write, edit, bash, glob, grep, skill_view). All use the `@tool` decorator which auto-coerces dict inputs to Pydantic models and auto-generates JSON Schema.
